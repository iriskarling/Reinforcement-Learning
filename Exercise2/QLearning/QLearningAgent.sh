...
./../../../bin/HFO --defense-agents=2  --offense-agents=1 --headless --offense-on-ball 11 --trials 5000 --deterministic --discrete=True --frames-per-trial 2000 --untouched-time 2000 &
sleep 5
