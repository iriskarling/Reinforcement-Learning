...
class HFOEnv(object):
	...
	def startEnv(self):
		if self.numTeammates == 0:
			...
			os.system("./../../../bin/HFO --seed {} --headless --defense-agents={} --defense-npcs=0 --offense-npcs={} --offense-agents=1 --trials 8000 --untouched-time 500 --frames-per-trial 500 --port {} --fullstate &".format(
